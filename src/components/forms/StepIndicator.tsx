  ...
  return (
    <div className="w-full lg:w-80 bg-white border-r border-gray-200 lg:h-full">
      ...
      <div className="hidden lg:block p-6 sticky top-0">
        <h2 className="text-xl font-semibold text-gray-900 mb-2">Create Your Demand</h2>
        <p className="text-sm text-gray-600 mb-8">
          Easily set up your demand in just three steps: Define basic information, add articles, and optionally attach files.
        </p>
        ...
        <div className="mt-8 p-4 bg-gray-50 rounded-lg">
          <h4 className="text-sm font-medium text-gray-700 mb-2">Progress Overview</h4>
