  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <div className="text-center">
        <h3 className="text-lg font-medium text-gray-900 mb-2">Optional File Attachment</h3>
        <p className="text-gray-600 text-sm sm:text-base">
          Add supporting documents to provide more context for your demand
        </p>
      </div>
      ...
      {!file && (
        <div className="max-w-lg mx-auto text-center p-4 sm:p-6 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <h4 className="text-sm font-medium text-blue-900 mb-2">
            No file attachment required
          </h4>
          <p className="text-sm text-blue-700">
            You can submit your demand without any files. This step is completely optional.
          </p>
        </div>
      )}
